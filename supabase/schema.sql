...
create table if not exists recruitment_applications (
  ...
  contract_accommodation_option text not null default 'accommodation_not_verified',
  verified_irish_residential_address text,
  contract_accommodation_verified_at timestamptz,
  contract_accommodation_verified_by text,
