...
-- Locks both shifts before swapping staff assignments so concurrent approvals cannot
-- produce a half-swapped rota.
...
begin
  ...
  if not found or a.id is null or b.id is null then
    raise exception using errcode = 'P0002', message = 'One or both shifts no longer exist.';
  end if;
