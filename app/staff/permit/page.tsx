...
export default function StaffPermitPage() {
  ...
  return <main style={{ minHeight: '100vh', background: '#f4f7fb', color: '#102a43', fontFamily: 'system-ui', padding: 28 }}>
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <section style={{ ...card, marginTop: 18, marginBottom: 30 }}><h2 style={{ marginTop: 0 }}>What happens next</h2><ol style={{ lineHeight: 1.8, color: '#334e68' }}><li>Submit your request to BIMED from this page.</li><li>BIMED checks your complete profile, employment terms and supporting evidence.</li><li>BIMED prepares the employer-side permit/sponsorship documentation and confirms the applicable permit type.</li><li>Where required, BIMED completes any Labour Market Needs Test and related recruitment evidence before submission. DETE says an LMNT is required for many permit applications and an application should be received at least 12 weeks before the proposed start date. citeturn719283search7</li><li>After a permit decision, the visa stage is handled through the appropriate Irish immigration process where applicable.</li><li>Shift access stays blocked until the required permission to work is confirmed.</li></ol></section>
    </div>
  </main>;
}
