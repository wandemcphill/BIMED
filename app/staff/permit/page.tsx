    ...
    <div style={{ maxWidth: 1000, margin: '0 auto' }}>
      ...
      <section style={{ ...card, marginTop: 18 }}>
        ...
        {sharedPartner ? <div style={{ marginTop: 14, padding: 16, borderRadius: 12, background: '#eef7f7', color: '#334e68', lineHeight: 1.7 }}>
          ...
          <p style={{ lineHeight: 1.7 }}>You can change between <strong>€4,000 for 3 months</strong> and <strong>€1,250 for 1 month</strong> before payment is reported or recorded and before the employment-permit request is submitted. The <strong>€625 shared plan for 1 month</strong> is available when a compliant two-person shared accommodation arrangement is being established. A shared arrangement requires a verified BIMED accommodation partner and remains subject to the applicable occupancy limits. Your existing unpaid invoice will be superseded and a new invoice will be issued for the plan you choose.</p>
          <label style={{ display: 'flex', gap: 10, alignItems: 'flex-start', color: '#334e68', lineHeight: 1.6 }}>
            <input type='checkbox' checked={acknowledged} onChange={(e) => setAcknowledged(e.target.checked)} style={{ marginTop: 5, flexShrink: 0 }} />
