...
export default function StaffPermitPage() {
  ...
  async function changeAccommodationPlan() {
    if (!selectedPlan || !selectedRoute) { setError('Choose the new accommodation plan first.'); return; }
