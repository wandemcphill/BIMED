...
export default function StaffPermitPage() {
  ...
  return <main style={{ minHeight: '100vh', background: '#f4f7fb', color: '#102a43', fontFamily: 'system-ui', padding: 28 }}>
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <section style={{ ...card, marginTop: 18 }}><h2 style={{ marginTop: 0 }}>Travel to Ireland</h2><p style={{ color: '#627d98' }}>Prepare your planned home-country departure, passenger details and Dublin arrival date. BIMED will search live economy offers and create a virtual itinerary for its future booking workflow.</p><button onClick={() => router.push('/staff/travel')} style={button}>Open Dublin flight planning</button></section>
