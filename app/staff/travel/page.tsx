...
export default function StaffTravelPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      setMessage('Travel request submitted to Overseas Recruitment. BIMED will handle the actual economy flight booking and airport pickup after the required clearance.');
      await load();
  ...
  return <main style={{ minHeight: '100vh', background: '#f4f7fb', color: '#102a43', fontFamily: 'system-ui', padding: 'clamp(16px,4vw,28px)' }}>
    <div style={{ maxWidth: 1000, margin: '0 auto' }}>
      ...
      <div style={{ marginTop: 18 }}><div style={{ fontSize: 12, fontWeight: 900, letterSpacing: 1.3, color: '#0f766e' }}>PRE-ARRIVAL TRAVEL</div><h1 style={{ margin: '4px 0', fontSize: 'clamp(30px,6vw,44px)', lineHeight: 1.08 }}>Travel to Dublin</h1><p style={{ color: '#627d98', maxWidth: 820, fontSize: 'clamp(16px,2.5vw,20px)', lineHeight: 1.6 }}>Give BIMED the travel details it needs to arrange your journey to Ireland. You do not book or pay for the flight yourself, and supplier fares are not shown in the Staff Portal.</p></div>
