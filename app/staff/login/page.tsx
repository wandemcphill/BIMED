...
export default function StaffLoginPage() {
  ...
  return <main style={{minHeight:'100vh',display:'grid',placeItems:'center',background:'#f4f7fb',padding:24}}>
    <form onSubmit={submit} style={{width:'100%',maxWidth:440,background:'#fff',padding:32,borderRadius:20,boxShadow:'0 14px 44px rgba(15,23,42,.08)'}}>
      ...
      <div style={{background:'#f4f7fb',borderRadius:10,padding:12,fontSize:12,color:'#627d98',marginBottom:16}}>New hires: use your activation link first to create your password. After activation, you can sign in with either your BIMED ID or your BIMED email.</div><div style={{textAlign:'right',marginBottom:16}}><a href='/staff/password-reset' style={{color:'#0f766e',fontWeight:800,fontSize:13,textDecoration:'none'}}>Forgot your password?</a></div>
