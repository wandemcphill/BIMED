    ...
    <main style={{ minHeight: '100vh', background: '#f7f9fc', padding: '32px 5vw', fontFamily: 'system-ui', color: '#102a43' }}>
      <div style={{ maxWidth: 980, margin: '0 auto' }}>
        ...
        <section style={card}>
          ...
          <p style={{ color: '#627d98', marginTop: 0 }}>For internal BIMED employees who are not created through the care/clinical recruitment pathway.</p>
          ...
          {staff ? (
            <div style={successBox}>
              ...
              <div>Role: {staff.job_title}</div>
              {activationUrl && (
                <>
                  <p style={{ marginBottom: 8 }}>Activation link:</p>
                  <textarea readOnly value={activationUrl} rows={3} style={{ width: '100%', boxSizing: 'border-box', padding: 10, border: '1px solid #a7f3d0', borderRadius: 9 }} />
                  <button onClick={() => void copyActivation()} style={{ ...primaryButton, marginTop: 8 }}>Copy activation link</button>
                </>
              )}
